...
namespace GreatLand.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private List<Claim> GetClaims(LoginViewModel model)
        {
            var claims = new List<Claim>();
            claims.Add(new Claim(ClaimTypes.Email, model.Email));
            claims.Add(new Claim(ClaimTypes.Name, "NA"));
            //claims.Add(new Claim(DemoIdentity.IPClaimType, "128.236.333.2"));
            claims.Add(new Claim(DemoIdentity.IdClaimType, model.Email));
            //claims.Add(new Claim(ClaimTypes.Name, "assilabdulrahim@gmail.com"));
            //claims.Add(new Claim(ClaimTypes.Name, "minh.bui"));
        ...
        public ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                if (true) //Check the database
                {
                    ...
                    //We validate this login 
                    BusinessLogic.BusinessLogic chk = new BusinessLogic.BusinessLogic();
                    var good = chk.IsValidUser(model);
                    if (!good)
                    {
                    ...
                    List<Claim> claims = GetClaims(model); //Get the claims from the headers or db or your user store
                    if (null != claims)
                    {
                        SignIn(claims);
        ...
        //    var pwd = model.Password; //User.Identity.GetUserId();
        ...
        //    if (model.Email == "admin@greatlandtours.com" && model.Password == "123")
        //    {
        //        result = SignInStatus.Success;           
        //    }
        //    else if (model.Email =="tester1@greatlandtours.com" && model.Password == "123")
        //    {
        //        result = SignInStatus.Success;
        //    }
        //    else if (model.Email == "tester2@greatlandtours.com" && model.Password == "456")
        //    {
        //        result = SignInStatus.Success;
        //    }
        //    else if (model.Email == "tester3@greatlandtours.com" && model.Password == "789")
        //    {
        //        result = SignInStatus.Success;
        //    }
        //    else
