...
namespace GreatLand.Reports
{
    public partial class MainReport : System.Web.UI.Page
    {
        ...
        private void RenderReport()
        {
            ...
            appReportViewer.LocalReport.ReportPath = Server.MapPath("~\\bin\\Reports\\Main.rdlc");
            //appReportViewer.LocalReport.ReportPath = Server.MapPath("Main.rdlc");
            //appReportViewer.LocalReport.SetParameters(new Microsoft.Reporting.WebForms.ReportParameter("", ""));
            ReportParameter[] rptParams = new ReportParameter[]
            {
                new ReportParameter("casino", DropDownCasino.SelectedItem.ToString()),
            ...
            {
                casinoReport = dal.GetMainReport(DropDownCasino.SelectedValue, DateTime.Parse(TxtFrom.Text), DateTime.Parse(TxtTo.Text));
            }
            else
            {
                casinoReport = dal.GetMainReport(DropDownCasino.SelectedValue, DateTime.Parse(DateTime.Now.ToShortDateString()), DateTime.Parse(DateTime.Now.ToShortDateString()));
            }
            
            var reportDataSource = new Microsoft.Reporting.WebForms.ReportDataSource();
            reportDataSource.Name = "CasinoReportDataset";
